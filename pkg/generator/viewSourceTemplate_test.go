...
func validateViewSource(tmpDir string, t *testing.T) {
	s, err := ioutil.ReadFile(path.Join(tmpDir, "internal", "kafmesh", "details", "testMesh_testId_test_viewSource.km.go"))
	if err != nil {
		t.Fatal(err)
	}

	assert.Equal(t, expectedViewSource, string(s))
}

var (
	expectedViewSource = `// Code generated by kafmesh-gen. DO NOT EDIT.
