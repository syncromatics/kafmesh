...
func Test_ViewSource_Component(t *testing.T) {
	repo := repos.ViewSource()

	r, err := repo.ComponentByViewSources(context.Background(), []int{1, 2, 3, 4})
...
func Test_ViewSource_Pods(t *testing.T) {
	...
	r, err := repo.PodsByViewSources(context.Background(), []int{1, 2, 3, 4})
	assert.NilError(t, err)
...
func Test_ViewSource_Topic(t *testing.T) {
	...
	r, err := repo.TopicByViewSources(context.Background(), []int{1, 2, 3, 4})
	assert.NilError(t, err)
