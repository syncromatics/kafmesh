...
// source: kafmesh/ping/v1/ping_api.proto
...
func (*PingRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_634d1d0478da8e10, []int{0}
}
...
func (*PingResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_634d1d0478da8e10, []int{1}
}
...
func init() {
	proto.RegisterType((*PingRequest)(nil), "kafmesh.ping.v1.PingRequest")
...
var fileDescriptor_634d1d0478da8e10 = []byte{
	...
	,
}
...
func (c *pingAPIClient) Ping(ctx context.Context, in *PingRequest, opts ...grpc.CallOption) (*PingResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/kafmesh.ping.v1.PingAPI/Ping", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _PingAPI_Ping_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/kafmesh.ping.v1.PingAPI/Ping",
	}
...
var _PingAPI_serviceDesc = grpc.ServiceDesc{
	ServiceName: "kafmesh.ping.v1.PingAPI",
	...
	Metadata: "kafmesh/ping/v1/ping_api.proto",
}
